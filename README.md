# Проект по автоматизации тестирования homecredit.ru
<a href="https://www.homecredit.ru/"><img width="50%" title="HomeCredit" src="images/logo/Homecredit_logo.png"></a>
...
- Проверка работы страницы 'Дебетовой карты' (c PageObjects)
- Проверка работы страницы активации карты (c PageObjects)
